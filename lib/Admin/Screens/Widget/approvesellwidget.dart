...
import 'package:mgxchangeadmin/Admin/Screens/Widget/aproveselldetails.dart';
import 'package:get/get.dart';
import 'package:mgxchangeadmin/Data/Constant.dart';


Widget buildapprovesellcard(BuildContext context, index){
  final data = ApproveSellList.list[index];
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              ...
              Get.to(ApproveSellDetails(img: data.img,
