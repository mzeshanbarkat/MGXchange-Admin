...
import 'package:mgxchangeadmin/Admin/Screens/Widget/sellitemdetails.dart';
import 'package:mgxchangeadmin/Data/Constant.dart';
import 'package:mgxchangeadmin/Rider/Screens/Utilis/ridersellcardlist.dart';


Widget buildridersellcard(BuildContext context, index) {
  final data = RiderSellCardList.list[index];
          ...
          InkWell(
            onTap: () {
             // oncardtap(context,index);
              Get.to(SellitemDetails(img: data.img,
